    ...
    <section class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-4 py-12">
      <div class="text-center pb-12">
        ...
        <div class="flex items-center justify-center">
          <div class="max-w-xl flex flex-col text-center">
            <h3 class="mt-6 text-xl leading-8 text-gray-200">
              Our team, VEXT GAMES, is a diverse and talented group with members
              hailing from Hong Kong, the UK, Nigeria, Mauritius, and beyond.
            </h3>
          </div>
        </div>
      </div>
      <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div class="hover:animate-shadowPulse w-full bg-[#02456b] rounded-lg p-12 flex flex-col justify-center items-center">
          ...
          <div class="text-center">
            ...
            <p class="text-xl text-indigo-200 font-normal">Software Engineer</p>
          </div>
        </div>
        <div class="hover:animate-shadowPulse w-full bg-[#02456b] rounded-lg p-12 flex flex-col justify-center items-center">
          <div class="mb-8">
          ...
          <div class="text-center">
            ...
            <p class="text-xl text-indigo-200 font-normal">Graphic Designer</p>
          </div>
        </div>
        <div class="hover:animate-shadowPulse w-full bg-[#02456b] rounded-lg p-12 flex flex-col justify-center items-center">
          <div class="mb-8">

      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:text-center">
          ...
          <p className="mt-6 text-lg leading-8 text-white text-justify">
            Our core values—Versatility, Evolutionary, Xtraordinary, and
            Tenacity—set us apart. We're committed to adapting to market
            changes, driving innovation, and creating unique games that stand
            out.
          </p>
        </div>
